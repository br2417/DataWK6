	...
	*/
	...
	function mDataLoaded(CivUnempRate){
		...
		// I also used the gChartOptions variable to create objects to adjust the size of the chart, and its position from the left border
		 ...
		 var gChartOptions = {
         title: "Civil Unemployment Rate since 1948",     
    	 width: 1500,
       	 height: 500,
       	 chartArea: {
       	 	left: 100
	...
	function gLoaded(){
		...
		$.get("https://www.googleapis.com/fusiontables/v1/query?sql=SELECT+*+FROM+12A0eKUXKb4TCFhngfaGqaMEH6uECY1iBhd3VOBAV&key=AIzaSyDsBrSpJRliKgi913vr9FWTy8oL57c42bA", mDataLoaded, "json");
